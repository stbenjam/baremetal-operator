...
func (in *BIOSConfig) DeepCopyInto(out *BIOSConfig) {
	*out = *in
	if in.IRMC != nil {
		in, out := &in.IRMC, &out.IRMC
		*out = new(IRMCSettings)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IRMCSettings) DeepCopyInto(out *IRMCSettings) {
	*out = *in
	if in.EnableCheckControllersHealthStatus != nil {
		in, out := &in.EnableCheckControllersHealthStatus, &out.EnableCheckControllersHealthStatus
		*out = new(bool)
		**out = **in
	}
	if in.CPUActiveProcessorCores != nil {
		in, out := &in.CPUActiveProcessorCores, &out.CPUActiveProcessorCores
		*out = new(int)
		**out = **in
	}
	if in.EnableCPUAdjacentCacheLinePrefetch != nil {
		in, out := &in.EnableCPUAdjacentCacheLinePrefetch, &out.EnableCPUAdjacentCacheLinePrefetch
		*out = new(bool)
		**out = **in
	}
	if in.EnableFlashWrite != nil {
		in, out := &in.EnableFlashWrite, &out.EnableFlashWrite
		*out = new(bool)
		**out = **in
	}
	if in.EnableKeepVoidBootOptions != nil {
		in, out := &in.EnableKeepVoidBootOptions, &out.EnableKeepVoidBootOptions
		*out = new(bool)
		**out = **in
	}
	if in.EnableLaunchCSM != nil {
		in, out := &in.EnableLaunchCSM, &out.EnableLaunchCSM
		*out = new(bool)
		**out = **in
	}
	if in.EnableOSEnergyPerformanceOverride != nil {
		in, out := &in.EnableOSEnergyPerformanceOverride, &out.EnableOSEnergyPerformanceOverride
		*out = new(bool)
		**out = **in
	}
	if in.EnablePciAbove4GDecoding != nil {
		in, out := &in.EnablePciAbove4GDecoding, &out.EnablePciAbove4GDecoding
		*out = new(bool)
		**out = **in
	}
	if in.EnableSingleRootIOVirtualizationSupport != nil {
		in, out := &in.EnableSingleRootIOVirtualizationSupport, &out.EnableSingleRootIOVirtualizationSupport
		*out = new(bool)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IRMCSettings.
func (in *IRMCSettings) DeepCopy() *IRMCSettings {
	if in == nil {
		return nil
	}
	out := new(IRMCSettings)
